...
export class IDOFactory extends Entity {
  ...
  set divider(value: BigInt) {
    this.set("divider", Value.fromBigInt(value));
  }
...
export class TokensDebt extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save TokensDebt entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type TokensDebt must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("TokensDebt", id.toString(), this);
    }
  }

  static loadInBlock(id: string): TokensDebt | null {
    return changetype<TokensDebt | null>(store.get_in_block("TokensDebt", id));
  }

  static load(id: string): TokensDebt | null {
    return changetype<TokensDebt | null>(store.get("TokensDebt", id));
  }
...
export class TokensWithdrawn extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type TokensWithdrawn must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("TokensWithdrawn", id.toString(), this);
    }
  }

  static loadInBlock(id: string): TokensWithdrawn | null {
    return changetype<TokensWithdrawn | null>(
      store.get_in_block("TokensWithdrawn", id)
    );
  }

  static load(id: string): TokensWithdrawn | null {
    return changetype<TokensWithdrawn | null>(store.get("TokensWithdrawn", id));
  }
